...
import CognitiveComplexity exposing (generateConfig, rule, rule2)
                ...
                sourceCodeWithComplexity6
                    ...
                    |> Review.Test.expectGlobalErrors
                        [ { message = "Congratulations, you have made your code less complex than before!"
                          , details =
                                [ "You now need to update your configuration in order to prevent complexity from creeping back in."
                                , "To do that, please copy paste the following code in 'CognitiveComplexityConfiguration.elm', next to your 'ReviewConfig.elm'."
                                , """module CognitiveComplexityConfiguration exposing (config)

{-| These suppressions are here to help you gradually lower the complexity of your modules and to prevent them from going up.

This file's contents are generated by the CognitiveComplexity rule as complexities go down.

If you need to regenerate this from scratch, please temporarily configure the rule in your ReviewConfig like this:

    CognitiveComplexity.generateConfig 3
...
suppressions =
    [ { moduleName = "A", threshold = 6 }
        ...
        , test "should sort suppressions by threshold" <|
            \() ->
                [ sourceCodeWithComplexity6
                , sourceCodeWithComplexity10
                ]
                    |> Review.Test.runOnModules
                        (rule2
                            [ { moduleName = "A", threshold = 8 }
                            , { moduleName = "Z", threshold = 12 }
                            ]
                            3
                        )
                    |> Review.Test.expectGlobalErrors
...
suppressions =
    ...
    , { moduleName = "A", threshold = 6 }
        ...
        , test "generateConfig should create a new configuration" <|
            \() ->
                [ sourceCodeWithComplexity6
                , sourceCodeWithComplexity10
                ]
                    |> Review.Test.runOnModules (generateConfig 8)
                    |> Review.Test.expectGlobalErrors
                        [ { message = "Congratulations, you have made your code less complex than before!"
                          , details =
                                [ "You now need to update your configuration in order to prevent complexity from creeping back in."
...
If you need to regenerate this from scratch, please temporarily configure the rule in your ReviewConfig like this:
    ...
    CognitiveComplexity.generateConfig 8
...
sourceCodeWithComplexity10 : String
sourceCodeWithComplexity10 =
    """module Z exposing (..)
fun n =
    if cond then        -- +1
